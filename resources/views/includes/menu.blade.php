...
<nav class="fixed top-0 z-0 bg-white dark:bg-black bg-opacity-90 dark:bg-opacity-90 w-full px-2 md:px-4 py-2.5">
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        <a href="#" class="flex items-center">
            {{-- logo --}}
            {{-- <svg class="-rotate-[15deg] -translate-y-1 my-2 fill-black dark:fill-white" stroke-width="2" width="90"
                viewBox="0 0 246 102" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="flex items-center md:order-last">
            ...
            <div class="hidden justify-between items-center w-full md:flex md:w-auto">
                <ul class="flex flex-col mt-4 font-medium md:flex-row md:space-x-2 md:mt-0">
                    ...
                    <li>
                        <a href="{{ route('login') }}" class="{{ active_link('login')}}">
                            {{ __('Log in') }}
                        </a>
                    </li>
                </ul>
            ...
            <ul id="main-menu" class="flex flex-col mt-4 font-medium md:flex-row md:space-x-4 md:mt-0">
                ...
                <li>
                    ...
                    <div id="mega-menu-dropdown"
                        class="hidden absolute z-10 grid-cols-2 md:grid-cols-3 w-auto rounded-lg border bg-white border-gray-200 shadow-md dark:border-gray-800 dark:bg-black ">
                        <div class="p-2 md:p-4">
                            <ul class="space-y-0 md:space-y-4" aria-labelledby="mega-menu-dropdown-button">
                                <li>
                                    <a href="{{ route('fashion_illustrations') }}"
                                        class="{{ active_link('fashion_illustrations') }}">
                ...
                <li>
                    <a href="{{ route('master_classes') }}" class="{{ active_link('master_classes') }}"
                        aria-current="page">
                        {{ __('Master classes') }}
                    </a>
                </li>
