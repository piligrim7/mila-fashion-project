...
@section('title')
	{{ __('My work') }} - {{ __('Fashion illustrations') }}
@endsection

@section('main_content')
<img class="float-right m-3 md:m-4" src="{{ Vite::asset ('resources/images/about_me.png') }}" alt="Sketch picture"/>
<div class="p-4 md:p-5">
	<h1 class="text-5xl sm:text-6xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100"> Fashion illustrations. Title of a longer featured blog post</h1>
